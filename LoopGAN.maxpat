...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 856.0, 305.0, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1054.086739152669907, 230.920169770717621, 146.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1039.086739152669907, 215.920169770717621, 146.0, 21.0 ],
					"presentation" : 1,
					"presentation_linecount" : 2,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1024.086739152669907, 200.920169770717621, 146.0, 21.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 713.75, 128.920169770717621, 194.0, 26.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 856.0, 334.384617447853088, 43.0, 19.5 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 856.0, 359.384617447853088, 65.0, 22.0 ],
					"text" : "0 0 0 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 856.0, 388.653846442699432, 263.0, 146.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1009.086739152669907, 185.920169770717621, 146.0, 50.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 921.086739152669907, 164.499998450279236, 80.0, 22.0 ],
					"text" : "loadmess 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 921.086739152669907, 195.920169770717621, 50.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 49.266150772571564, 334.415998466212045, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1026.384615063667297, 1074.972619354724884, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 1026.384615063667297, 1014.972619354724884, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 1026.384615063667297, 948.972619354724884, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 733.076918482780457, 1074.972619354724884, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 733.076918482780457, 1014.147863686084747, 256.0, 64.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 733.076918482780457, 949.967446982860565, 256.0, 64.0 ]
				}
...
,
					"patching_rect" : [ 350.446325433002471, 738.189901173114777, 135.264589000000001, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 830.0, 585.923076570034027, 80.0, 22.0 ],
					"text" : "speedlim 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 830.0, 551.423075735569, 201.0, 22.0 ],
					"text" : "pak /generate_xy 0. 0. 0. 0. 0. 0. 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 780.576918482780457, 264.153845191001892, 229.0, 22.0 ],
					"text" : "pack /generate_random 0. 0. 0. 0. 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 339.469061017036438, 668.247422218322754, 197.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 90.443297207355499, 623.959125459194183, 197.0, 22.0 ],
					"text" : "mc.mixdown~ 4 @pancotrolmode 1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 787.576918482780457, 684.459128379821777, 142.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 296.288266264777576, 409.698444329945346, 230.513216733932438, 167.389692143950128 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 613.576923012733459, 779.423075735569, 1254.0, 1182.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 538.063706278800964, 35.99699759125383, 397.513216733932495, 542.091138882641644 ],
					"proportion" : 0.5
				}
